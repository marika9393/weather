...
public class WindDirectionMapperTest {
    ...
    void mapWindDirection_returnsCorrectValue(int degree, String expectedValue) {
        // when
        String result = windDirectionMapper.windDirectionMapp(degree);
    ...
    void mapWindDirection_whenValueIsOutOfRange_throwsException(int degree) {
        // when
        Throwable result = catchThrowable(() -> windDirectionMapper.windDirectionMapp(degree));
